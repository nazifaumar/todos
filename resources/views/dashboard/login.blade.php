...
<div class="container d-flex justify-content-center align-items-center mt-5">
    <form method="POST" action="{{route('login.auth')}}" class="card py-4 px-4">
        ...
        <div class="position-relative mt-3 form-input">
            ...
            <input class="form-control opacity-25 btn-outline-dark" type="text" name="username">
            <i class="fas fa-user"></i>
        </div>
        <div class="position-relative mt-3 form-input">
            <label>Password</label>
            <input class="form-control opacity-25 btn-outline-dark" type="password" name="password">
